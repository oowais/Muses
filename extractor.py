...
def get_all_features(file):
    ...
    mfcc_thread.start()
    chroma_cens_thread = ThreadWithReturnValue(target=librosa.feature.chroma_cens, args=(y, sr,))
    ...
    mel_thread = ThreadWithReturnValue(target=librosa.feature.melspectrogram, args=(y, sr,))
    mel_thread.start()
